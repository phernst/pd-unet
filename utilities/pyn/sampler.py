...
import math
import numpy as np
from utilities.pyn.dcf import generateDCF
...
def createSampling(slice, noOfSpokes, fullresSpokesMulFactor=2, returnFullOM=True, returnInvOM=True, isGolden=True):
