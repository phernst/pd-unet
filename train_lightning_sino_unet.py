...
from utilities.transforms import ShiftCut, SinoUpsample, ToTensor, ZNorm
...
class SinoBilinUpsampling(LightningModule):
    def __init__(self, **kwargs):
        ...
        self.iradon = IRadon(kwargs['imsize'], -fully_angles, circle=False, scikit=True, use_filter=HannFilter())
        self.net = Net()
        ...
        self.trafo = [ShiftCut(imsize=kwargs['imsize'], PerformOnUnder=True, circle=False), SinoUpsample(fully_angle=fully_angles, under_angle=under_angles), ToTensor()]  # [SortSino(), ToTensor()]
...
if __name__ == '__main__':
    ...
    from test_lightning_sino_unet import main as TestMain
