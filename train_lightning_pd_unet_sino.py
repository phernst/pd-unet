...
class PrimalDual(LightningModule):
    def __init__(self, **kwargs):
        ...
        # self.gpu_aug = transforms.RandomAffine(
        #     degrees=90,
        #     translate=(.2, .2),
        #     scale=(.8, 1/.8),
    ...
    def training_step(self, batch, _):
        sparse_sino, full_sino, under_reco, _ = batch
...
if __name__ == '__main__':
    ...
    from test_lightning_pd_unet_sino import main as TestMain
    TestMain(LossType.L1)
