...
class PrimalDual(LightningModule):
    def __init__(self, **kwargs):
        ...
        self.net = Net(kwargs['imsize'], -under_angles, 5, 5, 10,
    ...
    def validation_step(self, batch, batch_idx):
        ...
        prediction = self(sparse_sino, under_reco)
        loss = self.loss(prediction, fulldata)
        accuracy = self.accuracy(self.radon(prediction), full_sino)
...
if __name__ == '__main__':
    ...
    from test_lightning_pd_orig import main as TestMain
