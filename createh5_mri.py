...
source_path = r'Data/CHAOS/FullyMATs/Normed/test/*.mat'
output_file = r'Data/CHAOS/equidist_sparse16_spokeifft_test.h5'
sp = 512
baseresolution = 256
...
everyNSpoke = 16  # to be used for sparse
interpOrder = 1

source_MATs = list(glob.iglob(source_path))
